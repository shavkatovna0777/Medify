...
function DocotorSingleCard() {
  ...
  return (
    <div className="doctor-card px-[15px]">
    <div className="doctor-card-wrapper flex relative z-[1] mb-[80px] bg-white h-[400px] mt-[2px] rounded-[15px] shadow-[11px_8px_35px_0_rgba(0,0,0,0.08)]">
      <div className="img-wrapper m-[-42px_0] rounded-[15px] overflow-hidden">
        <div className="doctor-image w-full h-[300px]">
          <Img
            src={selectedDoctor.imgSrc}
            className="relative align-top w-full h-full object-cover"
            alt={`${selectedDoctor.name} image`}
          />
        </div>
      </div>

      <div className="info-wrapper bg-[url(https://wgl-dsites.net/medify/wp-content/uploads/2019/08/team_bg.png)] flex-1 pl-[5.6%] m-[15px_15px_15px_0] flex flex-col content-center bg-center  bg-no-repeat justify-center pb-24">
        <h2 className="relative z-[1] mb-[24px] text-[42px] leading-[1.055] font-bold text-darkBlue">
          {selectedDoctor.name}
        </h2>
        ...
        <div className="info-icons absolute top-3/4 z-[1] group flex gap-2 mt-[-15px]">
