...
function Card({ title, imageUrl, description }) {
  return (
    <div className="card bg-white flex flex-col items-center justify-center p-10 rounded-[15px] shadow-[0_0_30px_0_rgba(0,42,106,0.1)] transform transition-transform duration-500 hover:-translate-y-5 slg:w-full slg:h-auto md:w-[98%]">
